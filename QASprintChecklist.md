...
## Environment & Build
- [x] Secrets hygiene (Tested 10/10/2025, likely put in to confirm testing, will need to remove when product is close to being finished.)
...
- [x] Protect sensitive routes (Tested 12/01/2025)
